  ...
  return (
    <section id="#Home" className="min-h-[90vh] flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-10 py-5 bg-[#FFFBEA]">
      ...
      <div className="text-center md:text-left space-y-6 max-w-xl">
        <h1 data-aos="fade-down" data-aos-duration="2500" className="text-4xl md:text-5xl font-fredoka font-bold text-amber leading-tight">
          Learn Yoruba the Fun Way!
        </h1>
        <p data-aos="fade-up" data-aos-duration="2500" className="text-gray-700 text-lg md:text-xl">
          Master the Yoruba language through games, characters, and interactive
          lessons. Built just for you!
        </p>
        <Link to="/login">
          <motion.button data-aos="zoom-in" data-aos-duration="2500" className="bg-amber my-2 text-white px-6 py-3 rounded-xl text-lg font-semibold  ``transition-all shadow-md  hover:translate-y-[-2px] duration-400 ease-in hover:bg-yellow-600">
            Get Started
          </motion.button>
        </Link>
      </div>
      ...
      <div  className="">
        ...
        <motion.img src={welcomeChar} alt="" className="" animate={{y: [0,-15,0], }} transition={{duration: 1, repeat:Infinity, ease:"easeInOut"}}/>
      </div>
    </section>
  );
}
