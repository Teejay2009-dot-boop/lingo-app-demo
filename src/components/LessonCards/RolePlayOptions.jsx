...
const RolePlayOptions = ({ data, onAnswer, disabled, isAnswered }) => {
  ...
  return (
    <div className="bg-white rounded-lg p-6 max-w-[700px] mx-auto text-center shadow">
      <h2 className="text-xl font-semibold mb-4">Role Play</h2>
      <p className="mb-4 text-gray-700 italic">🗣 {data.scenario}</p>
...
export default RolePlayOptions;
